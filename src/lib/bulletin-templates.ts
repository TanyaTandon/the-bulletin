    ...
    <body>
      <div class="container">
        <div class="photos-top">
          <div class="photo img" data-image-index="0" style="background-image: url('${images[0]
  }')"></div>
          <div class="photo img" data-image-index="1" style="background-image: url('${images[1]
  }')"></div>
          <div class="photo img" data-image-index="2" style="background-image: url('${images[2]
  }')"></div>
          <div class="photo img" data-image-index="3" style="background-image: url('${images[3]
  }')"></div>
        </div>
        <div class="text">
          ${bodyText}
        ...
        <div class="photos-bottom">
          <div class="photo-large img" data-image-index="4" style="background-image: url('${images[4]
  }')"></div>
          <div class="photo-large img" data-image-index="5" style="background-image: url('${images[5]
  }')"></div>
        </div>
    ...
    <div class="container">
      <div class="main-content">
        <div class="left-column">
          <div class="large-photo img" data-image-index="0" style="background-image: url('${images[0]
  }')"></div>
          <div class="text">
            ${bodyText}
          </div>
        ...
        <div class="right-column">
          ...
          <div class="photo img" data-image-index="4" style="background-image: url('${images[4]
  }')"></div>
        </div>
      </div>
      <h1 class="name" id="nameElement">${name.toLowerCase()}</h1>
