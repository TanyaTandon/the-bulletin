          ...
          <section className="w-full mt-3" data-tg-title="data-blurb-input">
            ...
            <div className="relative w-full flex flex-col items-end">
              <Textarea
                ...
                className={`data-blurb-input resize-none w-full max-w-3xl border-violet-200 bg-[#fcffef] focus:border-violet-400 focus:ring-violet-400 text-sm ${isMobile ? "min-h-[225px] text-[17px]" : "min-h-[300px]"
                  }`}
                maxLength={MAX_CHARS}
              />
          ...
          <Accordion type="multiple">
            {templates.map((template) => (
              <AccordionItem value={template.id.toString()}>
                ...
                <AccordionContent
                  className={`data-[state=${selectedTemplate.id === template.id ? "open" : "closed"
                    }]`}
                >
