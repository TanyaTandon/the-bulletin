...
const Index = () => {
  ...
  return (
    <Layout>
      <TypewriterText text={`Hey ${user?.user_metadata?.name || 'there'}. Welcome to the bulletin. Upload notes, pictures, writing pieces, art, month summaries and we will curate a bulletin and physically mail it to your friends.`} />
      
      <Tabs defaultValue="content" className="mt-6">
        <TabsList>
          <TabsTrigger value="content">Your Content</TabsTrigger>
          <TabsTrigger value="profiles">User Profiles Database</TabsTrigger>
        </TabsList>
